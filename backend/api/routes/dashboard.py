...
from models import Project, InvoiceOut, InvoiceIn, Staff, User, Receipt
...
async def dashboard_summary(
    ...
    q_receipt = select(func.coalesce(func.sum(Receipt.amount), 0))
    ...
    if user.role != "super_admin" and user.tenant_id:
        ...
        q_receipt = q_receipt.where(Receipt.tenant_id == user.tenant_id)
