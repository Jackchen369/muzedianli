<template>
  <div class="login-page">
    <div class="login-card">
      <h2 class="login-title">沐泽电力管理系统</h2>
...
.login-title { text-align: center; margin-bottom: 30px; color: #303133; font-size: 24px; letter-spacing: 2px; }
</style>
